...
- A API valida o formato do código postal, consulta o GEO API PT e guarda `CODIGO_POSTAL`, `LOCALIDADE` e `PRAZO_VENDA` no Sender quando os campos personalizados existem.
