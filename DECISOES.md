...
- Ordenação: as novidades aparecem da mais recente para a mais antiga através do campo `data`. Quando duas novidades têm a mesma data, o identificador do ficheiro é ordenado de forma descendente, para que os nomes com hora de criação mais recente surjam primeiro.
