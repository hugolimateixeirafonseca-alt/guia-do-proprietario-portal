...
Promocode da parceria: `GUIAPRO_D2027`
Benefício do promocode: em vez de pagar inicialmente 230,00 € pela reserva, o utilizador paga apenas 80,00 €
...
- Confirmar com a Tribera que o promocode `GUIAPRO_D2027` está ativo e reduz o valor inicial da reserva de 230,00 € para 80,00 €.
...
A landing não dispara `Lead` nem `Contact`, porque não recolhe um contacto. O clique para a reserva pode ser medido separadamente. A atribuição comercial do contrato é feita através do promocode `GUIAPRO_D2027`, pelo que o utilizador deve ser incentivado a introduzi-lo no momento da reserva.
