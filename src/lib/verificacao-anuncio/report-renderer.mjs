...
export function renderReportHtml({ report, createdAt, expiresAt, capturePreviews = [] }) {
  ...
  .decision{display:grid;grid-template-columns:74px 1fr;gap:24px;align-items:start;margin:28px 0 8px;padding:30px 34px;border-radius:24px;box-shadow:0 24px 58px rgba(16,47,42,.15)}.decision.danger{background:linear-gradient(135deg,#9b3829,#d05b37);color:#fff}.decision.caution{background:linear-gradient(135deg,#123f49,#0d6255);color:#fff}.decision.positive{background:linear-gradient(135deg,#164d3e,#32835f);color:#fff}.decision-icon{display:grid;width:68px;height:68px;place-items:center;border:1px solid rgba(255,255,255,.45);border-radius:20px;background:rgba(255,255,255,.13);font-size:31px;font-weight:950}.decision-label{display:inline-block;margin-bottom:8px;padding:6px 10px;border-radius:999px;background:#d9ff72;color:#123c32;font-size:9px;font-weight:950;letter-spacing:.1em;text-transform:uppercase}.decision h2{max-width:840px;margin:0;font-size:clamp(25px,3.5vw,44px);line-height:1.05;letter-spacing:-.04em}.decision p{max-width:820px;margin:12px 0;color:rgba(255,255,255,.86);font-size:13px;line-height:1.6}.decision-rule{display:block;color:#fff;font-size:11px}.summary{grid-template-columns:repeat(3,1fr);padding:16px 0 22px}.photo-feature{position:relative;overflow:hidden;margin:0 0 24px;border:1px solid #bcd8c5;border-radius:24px;background:linear-gradient(135deg,#eff9ee 0%,#fff 58%,#edf7f4 100%);box-shadow:0 24px 55px rgba(16,47,42,.1)}.photo-feature:after{content:"";position:absolute;right:-85px;top:-110px;width:300px;height:300px;border-radius:50%;background:rgba(102,170,120,.09);pointer-events:none}.photo-feature.attention{border-color:#e7b6a8;background:linear-gradient(135deg,#fff1ec 0%,#fff 58%,#fff6eb 100%)}.photo-feature-head{position:relative;z-index:1;display:flex;align-items:center;justify-content:space-between;padding:20px 28px;border-bottom:1px solid rgba(62,135,93,.17)}.photo-feature-kicker{color:var(--green);font-size:10px;font-weight:950;letter-spacing:.15em;text-transform:uppercase}.photo-feature.attention .photo-feature-kicker{color:var(--red)}.photo-feature-count{padding:7px 11px;border-radius:999px;background:#fff;color:#49645c;font-size:10px;font-weight:850;box-shadow:0 5px 18px rgba(16,47,42,.07)}.photo-feature-body{position:relative;z-index:1;display:grid;grid-template-columns:190px minmax(0,1fr) 265px;gap:30px;align-items:center;padding:30px 34px 28px}.photo-score{display:grid;place-items:center;align-content:center;width:164px;height:164px;border:15px solid rgba(62,135,93,.18);border-top-color:var(--green);border-right-color:var(--green);border-radius:50%;background:#fff;box-shadow:inset 0 0 0 1px rgba(62,135,93,.08),0 14px 35px rgba(16,47,42,.09)}.photo-feature.attention .photo-score{border-color:rgba(187,86,63,.17);border-top-color:var(--red);border-right-color:var(--red)}.photo-score strong{font-size:43px;line-height:1;letter-spacing:-.06em}.photo-score span{margin-top:5px;color:var(--grey);font-size:9px;font-weight:850;text-transform:uppercase}.photo-feature-label{display:inline-flex;margin-bottom:10px;padding:6px 9px;border-radius:999px;background:#dff0df;color:#2f714d;font-size:9px;font-weight:950;letter-spacing:.08em;text-transform:uppercase}.photo-feature.attention .photo-feature-label{background:var(--red2);color:#9e4935}.photo-feature-copy h2{max-width:650px;margin:0;font-size:clamp(25px,3vw,38px);line-height:1.06;letter-spacing:-.045em}.photo-feature-copy>p{max-width:650px;margin:13px 0 18px;color:#4f6861;font-size:12px;line-height:1.6}.photo-dots{display:flex;flex-wrap:wrap;gap:8px}.photo-dot{display:grid;width:31px;height:31px;place-items:center;border-radius:9px;background:#dcefe0;color:#2d7b4f;font-size:11px;font-style:normal;font-weight:950}.photo-dot.attention{background:var(--red2);color:var(--red)}.photo-dot.unresolved{background:var(--amber2);color:var(--amber)}.photo-meaning{padding:19px;border:1px solid rgba(62,135,93,.17);border-radius:15px;background:rgba(255,255,255,.77)}.photo-meaning b{display:block;margin-bottom:7px;font-size:11px}.photo-meaning p{margin:0;color:var(--grey);font-size:10px;line-height:1.55}.photo-legends{position:relative;z-index:1;display:flex;flex-wrap:wrap;gap:9px;padding:0 34px 26px}.photo-legend{display:flex;gap:7px;align-items:center;padding:8px 10px;border-radius:9px;background:#fff;color:#58706a;font-size:9px;box-shadow:0 5px 15px rgba(16,47,42,.05)}.photo-legend>i{width:8px;height:8px;border-radius:50%;background:var(--green)}.photo-legend.attention>i{background:var(--red)}.photo-legend.unresolved>i{background:var(--amber)}.photo-feature .photo-list{position:relative;z-index:1;display:grid;grid-template-columns:repeat(2,1fr);border-top:1px solid rgba(62,135,93,.17);background:rgba(255,255,255,.55)}.photo-feature .photo-row:nth-child(even){border-left:1px solid var(--line)}.photo-feature .source-links{position:relative;z-index:1;padding:15px 28px}.risk-stack{display:grid;gap:11px;padding:18px}.risk-item,.risk-clear{display:grid;grid-template-columns:42px 1fr;gap:14px;padding:17px;border-radius:13px}.risk-item{border:1px solid #f0c3b7;background:#fff5f1}.risk-clear{border:1px solid #c8dfd0;background:#f1f8f2}.risk-item>span,.risk-clear>span{display:grid;width:38px;height:38px;place-items:center;border-radius:11px;background:var(--red);color:#fff;font-weight:950}.risk-clear>span{background:var(--green)}.risk-item b,.risk-clear b{font-size:13px}.risk-item p,.risk-clear p{margin:5px 0;color:var(--grey);font-size:11px;line-height:1.5}.risk-item small{display:block;padding-top:8px;border-top:1px solid #efd8d1;color:#743e32;font-size:10px;line-height:1.45}.message-box{overflow:hidden;border-radius:20px;background:linear-gradient(145deg,#0b302b,#164d44);color:#fff;box-shadow:var(--shadow)}.message-head{padding:25px 27px 15px}.message-head>span{color:#d9ff72;font-size:9px;font-weight:950;letter-spacing:.12em;text-transform:uppercase}.message-head h2{margin:6px 0 5px;font-size:25px;letter-spacing:-.035em}.message-head p{margin:0;color:#bdd1cb;font-size:11px}.message-box textarea{display:block;width:calc(100% - 40px);min-height:210px;margin:4px 20px 20px;padding:19px;border:1px solid rgba(255,255,255,.17);border-radius:13px;outline:0;background:#fff;color:#173b35;font:500 12px/1.65 Inter,Aptos,"Segoe UI",Arial,sans-serif;resize:vertical}.conditions{margin:0;padding:4px 18px 18px;list-style:none}.conditions li{display:grid;grid-template-columns:30px 1fr;gap:11px;padding:14px 5px}.conditions li+li{border-top:1px solid var(--line)}.conditions li>span{display:grid;width:27px;height:27px;place-items:center;border-radius:8px;background:var(--amber2);color:var(--amber);font-weight:900}.conditions b{font-size:12px}.conditions p{margin:4px 0 0;color:var(--grey);font-size:10px;line-height:1.45}.price-card{display:grid;grid-template-columns:1fr auto 1fr;gap:18px;align-items:center;padding:24px;border:1px solid #c9dfd1;border-radius:17px;background:linear-gradient(120deg,#f4fbf3,#e8f5eb);box-shadow:0 9px 30px rgba(16,47,42,.045)}.price-card>div{display:grid;gap:5px}.price-card span{color:var(--grey);font-size:9px;font-weight:850;text-transform:uppercase}.price-card strong{font-size:24px}.price-card i{color:#7e918b;font-size:9px;font-style:normal;text-transform:uppercase}.price-card p{grid-column:1/-1;margin:2px 0 0;color:var(--grey);font-size:10px}.price-card a{grid-column:1/-1;width:max-content;color:var(--navy);font-size:10px;font-weight:850;text-decoration:none}.details-panel .panel-head{background:#f8faf8}
  .photo-score{position:relative;border:0;background:conic-gradient(var(--green) var(--photo-progress),rgba(62,135,93,.17) 0)}.photo-score:before{content:"";position:absolute;inset:15px;border-radius:50%;background:#fff;box-shadow:inset 0 0 0 1px rgba(62,135,93,.08)}.photo-feature.attention .photo-score{border:0;background:conic-gradient(var(--red) var(--photo-progress),rgba(187,86,63,.17) 0)}.photo-score strong,.photo-score span{position:relative;z-index:1}.photo-score span{max-width:95px;line-height:1.25;text-align:center}
  @media(max-width:900px){.photo-feature-body{grid-template-columns:155px 1fr}.photo-score{width:140px;height:140px}.photo-meaning{grid-column:1/-1}.photo-feature .photo-list{grid-template-columns:1fr}.photo-feature .photo-row:nth-child(even){border-left:0}}
  @media(max-width:680px){.decision{grid-template-columns:1fr;gap:15px;padding:24px}.decision-icon{width:52px;height:52px;border-radius:15px;font-size:24px}.decision h2{font-size:30px}.summary{grid-template-columns:1fr}.metric{min-height:auto}.photo-feature-head{padding:17px 18px}.photo-feature-body{grid-template-columns:1fr;gap:20px;padding:23px 20px}.photo-score{width:128px;height:128px;border-width:12px}.photo-score strong{font-size:36px}.photo-feature-copy h2{font-size:29px}.photo-feature-copy>p{font-size:11px}.photo-legends{padding:0 20px 21px}.price-card{grid-template-columns:1fr}.price-card i{display:none}.message-box textarea{min-height:270px}.risk-item,.risk-clear{grid-template-columns:34px 1fr;padding:14px}.risk-item>span,.risk-clear>span{width:32px;height:32px}}
  </style></head><body>
  <nav class="topbar"><div class="page"><div class="brand"><i>GP</i>Guia do Proprietário</div><div class="private">IA · Relatório privado</div></div></nav>
  <header class="report-head"><div class="page head-grid"><div><p class="kicker">Relatório produzido pelo sistema inteligente com IA</p><h1>A decisão antes de pagar<span>O que encontrámos, o que significa e o que deve fazer agora</span></h1><div class="created">Análise automática concluída em ${escapeHtml(datePt(createdAt))}</div></div><aside class="head-note"><b>Análise inteligente concluída</b>O sistema cruzou automaticamente o texto, as condições e as fotografias. Normalmente, este relatório fica pronto em poucos minutos.</aside></div></header>
  <main class="page">
