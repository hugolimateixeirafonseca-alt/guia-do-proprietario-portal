export const VERIFICATION_CONFIG = Object.freeze([
  {
    ...
    question: "Pode enviar-me a localização exata ou, no mínimo, a cidade e a zona do imóvel?"
  },
  {
    id: 2,
    key: "preco_zona",
    ...
    question: "Pode confirmar a localização exata, o valor mensal e se existem outros pagamentos obrigatórios?"
  },
  {
    id: 3,
    key: "tipologia_area",
    ...
    question: "Pode confirmar por escrito a tipologia e a área do imóvel?"
  },
  {
    id: 4,
    key: "fotografias",
  ...
  },
  {
    ...
    question: "Que despesas estão incluídas no valor mensal e quais serão pagas à parte?"
  },
  {
    id: 6,
    key: "pagamentos",
    ...
    question: "Pode discriminar a caução, o sinal, a primeira renda e outras quantias, indicando quando deve ser pago cada valor?"
  },
  {
    id: 7,
    key: "visita",
    ...
    question: "É possível visitar o imóvel presencialmente antes de qualquer pagamento?"
  },
  {
    id: 8,
    key: "contrato",
    ...
    question: "Haverá contrato escrito? Pode enviar-me a minuta antes de qualquer transferência?"
  },
  {
    id: 9,
    key: "recibos",
    ...
    question: "Serão emitidos os recibos de renda aplicáveis?"
  },
  {
    id: 10,
    key: "titular_conta",
    ...
    question: "Qual é o nome completo do titular da conta que receberá o pagamento e qual é a relação com o arrendamento?"
  },
  {
    id: 11,
    key: "autorizacao_documental",
    name: "Propriedade ou autorização documental para arrendar o imóvel",
    minimumEvidence: "Exige documentação adequada que confirme quem é o proprietário ou está autorizado a arrendar o imóvel.",
    action: "Peça documentação adequada para confirmar quem é o proprietário ou está autorizado a arrendar o imóvel.",
    question: "Pode enviar documentação que confirme quem é o proprietário ou está autorizado a arrendar o imóvel?"
  },
  {
    id: 12,
    ...
    question: "Como será feita a comunicação do contrato às Finanças e a emissão dos recibos aplicáveis?"
  }
]);
